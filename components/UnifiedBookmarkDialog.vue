...
<style scoped>
.unified-bookmark-dialog :deep(.el-dialog) {
  border-radius: 12px;
  box-shadow: 0 20px 60px rgba(0, 0, 0, 0.2);
}

.unified-bookmark-dialog :deep(.el-dialog__header) {
  background: #f8fafc;
  border-bottom: 1px solid #e2e8f0;
  padding: 20px;
}

.unified-bookmark-dialog :deep(.el-dialog__title) {
  font-size: 18px;
  font-weight: 600;
  color: #2d3748;
}

.unified-bookmark-dialog :deep(.el-dialog__body) {
  padding: 20px;
}

.unified-bookmark-dialog :deep(.el-form-item__label) {
  font-weight: 500;
  color: #4a5568;
}
...
.unified-bookmark-dialog :deep(.el-dialog__footer) {
  padding: 20px;
  background: #f8fafc;
...
/* 动画效果 */
.unified-bookmark-dialog :deep(.el-overlay) {
